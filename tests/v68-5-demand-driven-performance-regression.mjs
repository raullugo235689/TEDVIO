...
const teacher=read('teacher.html'),beta=read('beta.html'),boot=read('teacher-progressive-boot-v68.js'),teacherCore=read('teacher-core-v68-6.js'),theme=read('teacher-theme-v68-7.js'),agenda=read('teacher-agenda-v75.js'),periods=read('teacher-periods-v76.js'),live=read('live-classroom-v58.js'),learning=read('beta-learning.js'),stability=read('beta-stability.js');
...
const allowedDirect=['config.js','runtime-core-v64.js','teacher-core-v68-6.js','teacher-progressive-boot-v68.js','teacher-theme-v68-7.js','teacher-command-center-v70.js','teacher-agenda-v75.js','teacher-periods-v76.js'];
...
must(direct.length===allowedDirect.length&&allowedDirect.every(name=>direct.some(src=>src.includes(name)))&&unexpectedDirect.length===0,`teacher keeps the audited split-core scripts plus lightweight agenda/period context (${direct.length})`);
...
console.log('\nTEDVIO v68.5 demand principles remain strengthened with lightweight v75/v76 academic context.');
