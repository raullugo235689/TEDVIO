...
const teacher=read('teacher.html'),beta=read('beta.html'),boot=read('teacher-progressive-boot-v68.js'),core=read('teacher-core-v68-6.js'),agenda=read('teacher-agenda-v75.js'),periods=read('teacher-periods-v76.js'),router=read('teacher-router-v76-3.js');
...
const allowedCore=['config.js','runtime-core-v64.js','teacher-core-v68-6.js','teacher-progressive-boot-v68.js','teacher-theme-v68-7.js','teacher-command-center-v70.js','teacher-agenda-v75.js','teacher-periods-v76.js','teacher-router-v76-3.js'];
...
must(teacher.includes('teacher-agenda-v75.js?v=75')&&teacher.includes('teacher-periods-v76.js?v=76')&&teacher.includes('teacher-router-v76-3.js?v=763'),'teacher loads explicitly audited agenda + period + no-flash router controllers');
...
must(!router.includes('setInterval(')&&!router.includes('new MutationObserver'),'no-flash router adds no polling or DOM observer');
must(!/createClient|\.from\(|\.rpc\(/.test(router),'no-flash router adds no backend work');
...
console.log('\nTEDVIO v68.4+ compatibility passes with v70 + v75/v76 academic context + v76.3 No-Flash UI.');
