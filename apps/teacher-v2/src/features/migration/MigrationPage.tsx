...
type ModuleKey = 'gradebook' | 'periods' | 'reports' | 'settings';

const modules: Record<ModuleKey, { eyebrow: string; title: string; detail: string; icon: IconName; phase: string; preserved: string[] }> = {
  gradebook: { eyebrow: 'CALIFICACIONES', title: 'El libro será migrado como módulo central', detail: 'Ponderaciones, evidencias, pendientes y Alumno 360° se moverán sin recalcular ni borrar datos.', icon: 'grades', phase: 'Fase 4C–4D', preserved: ['Categorías', 'Actividades', 'Calificaciones', 'Alumno 360°'] },
